...
int main()
{
    ...
    const int EPOCHS = 5;//0;

    // Labeled dataset that contains data for training is loaded from CSV file,
    // rows represent features, columns represent data points.
    arma::mat dataset;
    fname = Helper::PathNameService::findFileAboveCurrentDirectory("mnist_train.csv").value();
    data::Load(fname, dataset, true);
    ...
    fname = Helper::PathNameService::findFileAboveCurrentDirectory("mnist_test.csv").value();
    data::Load(fname, dataset, true);
